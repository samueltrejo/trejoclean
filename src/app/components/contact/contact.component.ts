    ...
    <div class="container">
      ...
      <div class="contact-container">
        ...
        <div class="contact-form">
          <form [formGroup]="messageForm" ngNativeValidate (submit)="SendMessage()">
            <div class="form-group">
              <input id="name" type="text" placeholder=" " autocomplete="one-time-code" formControlName="name" required />
              <label for="name">First Name</label>
            </div>
            <div class="form-group">
              <input id="email" type="email" placeholder=" " autocomplete="one-time-code" formControlName="email" required />
              <label for="email">Email Address</label>
            </div>
            <small>(Optional) Can we call you? Provide your phone.</small>
            <div class="form-group">
              <input id="phone" type="text" placeholder=" " autocomplete="one-time-code" formControlName="phone" />
            ...
            <div class="form-group">
              <textarea id="message" placeholder=" " autocomplete="one-time-code" formControlName="message"></textarea>
              <label for="message">Short Message</label>
            </div>
            <button type="submit" class="btn">Request a Free Quote</button>
            <div class="socials">
              <a href="tel:+16159444791" title="(615)944-4791" target="_blank" rel="noopener noreferrer" style="color: var(--accent-color);"><i class="fas fa-phone"></i></a>
              <a href="mailto:trejomsamuel@gmail.com" title="trejomsamuel@gmail.com" target="_blank" rel="noopener noreferrer" style="color: var(--accent-color);"><i class="fas fa-envelope"></i></a>
              <!-- <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" style="color: var(--accent-color);"><i class="fas fa-map-marker-alt"></i></a> -->
              <!-- <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" style="color: var(--accent-color);"><i class="fas fa-clock"></i></a> -->
              <a href="https://www.facebook.com/trejoclean" target="_blank" rel="noopener noreferrer" style="color: var(--accent-color);"><i class="fab fa-facebook-f"></i></a>
              <!-- <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" style="color: var(--accent-color);"><i class="fab fa-twitter"></i></a> -->
              <a href="https://www.instagram.com/trejoclean" target="_blank" rel="noopener noreferrer" style="color: var(--accent-color);"><i class="fab fa-instagram"></i></a>
              <!-- <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" style="color: var(--accent-color);"><i class="fab fa-linkedin-in"></i></a> -->
            </div>

            <div *ngIf="notification" class="notifications">
              <div class="email-toast text-light d-flex rounded">
                <i class="fas fa-envelope-open-text me-3 mt-1"></i>
                <div class="content">
                  <div class="title">Message Sent</div>
                  <div class="content">We have received your message. One of our trained professionals will contact you shortly.</div>
                </div>
              </div>
            </div>
...
export class ContactComponent {
  ...
  async SendMessage() {
    ...
    message.message += " (Client inquired about a free quote.)"
    message.date = new Date().toLocaleDateString(undefined, { weekday: 'long', month: 'long', day: 'numeric', year: 'numeric' }) + ' ' + new Date().toLocaleTimeString(undefined, { timeStyle: 'short' });
  ...
  ShowNotification() {
    ...
    setTimeout(() => this.notification = !this.notification, 6000)
  }
}
